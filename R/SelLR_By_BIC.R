#' Joint Selection of Learning Rate and Steps Based on BIC
#' 
#' @description 
#' Selects the optimal learning rate and number of optimization steps simultaneously using the BIC criterion.
#' 
...
#' @param lambda1 Fixed lambda1 parameter.
#' @param lambda2 Fixed lambda2 parameter.
#' @param learning_rate_vec Vector of candidate learning rates.
#' @param nsteps_vec Vector of candidate optimization steps.
#' 
#' @return A list containing the optimal learning rate, steps, and BIC matrix.
#' @export
